...
function Navbar() {
  ...
  sticky ? "sticky-navbar shadow-md bg-base-200 duration-300 transition-all ease-in-out z-10" : ""
}`}>
                <div className="navbar">
                    ...
                    <div className="navbar-end space-x-3">
                        ...
                        <div className="hidden md:block">
                            <label className="px-2 py-3 border rounded-md flex items-center gap-2">
